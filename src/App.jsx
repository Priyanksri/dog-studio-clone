  ...
  return (
    ...
    <main>
      <div className="images">
        ...
        <img id='navy-pier' src="models/NaviPier.png" alt="" />
        <img id='msi-chicago' src="models/MSIChicago.png" alt="" />
        <img id='phone' src="models/louisephone.png" alt="" />
      ...
      <section id="section-1">
        <nav>
          <div className='nav-elem'>
            <a href="https://dogstudio.co/" className="site-header-logo" title="Return to Dogstudio's homepage">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 401.23099 116.838">
        ...
        <div className='middle'>
          <div className='left'>
            <h1>We <br/> Make <br/> Good <br/> Stuff</h1>
          </div>
      ...
      <section id="section-4">
        <div className="bottom">
          <div className="left"></div>
          <div className="right">
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam est soluta expedita molestias ipsum aperiam quaerat. Reprehenderit voluptatem architecto eius non? At, animi praesentium error excepturi dolorum voluptas debitis sunt sapiente sit iure laudantium suscipit doloremque aut eveniet a voluptatibus ullam culpa, itaque quam atque! Accusamus, eligendi beatae? Quae, libero?</p>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis aspernatur deleniti voluptatibus saepe natus, totam sed doloribus officiis harum? Consequuntur illum magnam unde laborum architecto fuga non nobis beatae placeat nihil cupiditate modi, voluptate impedit ducimus voluptatum adipisci facilis dicta! Reprehenderit excepturi aperiam maiores iure at voluptatem natus sapiente corrupti.</p>
          </div>
        </div>
      </section>
